package ww222ag_assign2.exercise2;
...
public class FunctionPointers {
	...
	public static void main(String[] args) {
		...
		selectAndPrint(list, all);                // print all numbers
	
		
		
		System.out.print("\nPrint all odd numbers: ");
		Predicate<Integer> odd = n -> n % 2 == 1;      // n is odd
		selectAndPrint(list, odd);
	
		System.out.print("\nPrint all numbers greater than 10: ");
		Predicate<Integer> aboveTen = n -> n>10;   // n is more than 10
...
System.out.print(list.stream().filter(predicate).collect(Collectors.toList()));
		// Add code here
	}

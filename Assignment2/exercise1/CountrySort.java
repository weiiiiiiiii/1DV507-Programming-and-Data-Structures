package ww222ag_assign2.exercise1;
    ...
    public static void main(String[] args) {
		...
		// Task 3: Print Top 10 list of country names containing most As (either A or a). 
		   Comparator<String> countAs = (s1, s2) -> (int) (
				   (s2.chars().filter(ch -> ch == 'a').count() + s2.chars().filter(ch -> ch == 'A').count()) -
				   (s1.chars().filter(ch -> ch == 'a').count() + s1.chars().filter(ch -> ch == 'A').count()));       // Must be updated

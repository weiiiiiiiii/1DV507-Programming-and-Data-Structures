...
//Use the head-and-tail approach.
    ...
    //Adds int to the queue
     //  int element to add to the queue
    ...
    // the first element of the queue and remove it from the queue
     //@throws IllegalStateException when the queue is empty, @return int
    ...
    //Return the first element of the queue, @return int
    ...
    //Return the last element of the queue, @return int
